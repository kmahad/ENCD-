...
export function HelpPage() {
  ...
  const faqs: FAQItem[] = [
    ...
    },
    {
      ...
      answer: (
        <p>
          <strong>Nowhere.</strong> Everything runs 100% locally on your machine. All cryptographic algorithms run in your browser (or inside the desktop app shell). No data, files, or passwords are ever uploaded to a server or transmitted over a network.
        </p>
      ),
    },
    {
    ...
    {
      question: "What is the 500 MB limit?",
      answer: (
        <p>
          Web browsers load the entire file content into system memory (RAM) before encrypting or zipping. For files or folders larger than 500 MB, the browser may run out of memory and crash. For large files or folders, we recommend downloading our native <strong>Tauri Desktop app</strong> which uses Rust to stream files directly from disk without RAM limitations.
        </p>
      ),
    },
  ];
