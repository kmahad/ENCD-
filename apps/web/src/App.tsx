    ...
    <>
      ...
      <div className="app">
        ...
        <footer className="footer">
          <p>
            Files never leave your device. All encryption happens locally in
            your browser using AES-256-GCM and Argon2id.
          </p>
          <div
            style={{
              marginTop: "0.75rem",
          ...
          >
            <p className="footer__sub" style={{ margin: 0 }}>
              For very large folders (&gt;500 MB), download and install our
